...
export const FALLBACK_RESPONSE = "I'm not quite sure about that specific topic. Try asking about crops (like Tomato), pests, soil health, or market prices! You can also check our 'Cultivation Guides' for more details.";
